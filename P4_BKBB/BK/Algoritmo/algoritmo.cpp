...
/**
 * @class BK_solution
 * @brief TSP_solution class which implements backtracking algorithm
*/
...
private:
    ...
    /**
     * @brief Backtracking solution to the TSP problem
     * @param e_node The node (city) we are exploring in each recursive call
    */
