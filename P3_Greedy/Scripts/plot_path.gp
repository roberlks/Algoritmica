...
# Execution: gnuplot -c plot_graph.gp <data1> <data2> <title1> <title2> <output>
...
set xrange[0:1]
set yrange[0:1]
plot DATA1 using 2:3 with linespoints pointtype 7 title TITLE1, \
     DATA2 using 2:3 with linespoints pointtype 7 title TITLE2
#short version:
#using -> u
#with -> w
#linespoints -> lp
